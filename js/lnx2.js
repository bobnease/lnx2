...
let lnxObjects = [
    { index:  0, dec:      1, order: 18, tag: 'Website',   root: 'https://www.',                  suffix: '.com', icon: 'fas fa-globe',          live: false, verifyKey: null        },
    { index:  1, dec:      2, order:  1, tag: 'Instagram',  root: 'https://www.instagram.com/',    suffix: '',     icon: 'fab fa-instagram',       live: true,  verifyKey: 'instagram' },
    { index:  2, dec:      4, order:  2, tag: 'X',          root: 'https://www.x.com/',            suffix: '',     icon: 'fa-brands fa-x-twitter', live: false, verifyKey: 'x'         },
    { index:  3, dec:      8, order:  3, tag: 'YouTube',    root: 'https://www.youtube.com/',      suffix: '',     icon: 'fab fa-youtube',         live: false, verifyKey: 'youtube'   },
    { index:  4, dec:     16, order:  5, tag: 'Facebook',   root: 'https://www.facebook.com/',     suffix: '',     icon: 'fab fa-facebook',        live: false, verifyKey: 'facebook'  },
    { index:  5, dec:     32, order:  4, tag: 'TikTok',     root: 'https://www.tiktok.com/',       suffix: '',     icon: 'fab fa-tiktok',          live: false, verifyKey: 'tiktok'    },
    { index:  6, dec:     64, order: 12, tag: 'Twitch',     root: 'https://www.twitch.tv/',        suffix: '',     icon: 'fab fa-twitch',          live: false, verifyKey: 'twitch'    },
    { index:  7, dec:    128, order: 13, tag: 'Pinterest',  root: 'https://www.pinterest.com/',    suffix: '',     icon: 'fab fa-pinterest',       live: false, verifyKey: 'pinterest' },
    { index:  8, dec:    256, order:  8, tag: 'LinkedIn',   root: 'https://www.linkedin.com/in/',  suffix: '',     icon: 'fab fa-linkedin',        live: false, verifyKey: 'linkedin'  },
    { index:  9, dec:    512, order: 16, tag: 'Tumblr',     root: 'https://www.tumblr.com/',       suffix: '',     icon: 'fab fa-tumblr',          live: false, verifyKey: 'tumblr'    },
    { index: 10, dec:   1024, order: 14, tag: 'Telegram',   root: 'https://t.me/',                 suffix: '',     icon: 'fab fa-telegram',        live: false, verifyKey: 'telegram'  },
    { index: 11, dec:   2048, order: 17, tag: 'Vimeo',      root: 'https://www.vimeo.com/',        suffix: '',     icon: 'fab fa-vimeo',           live: false, verifyKey: 'vimeo'     },
    { index: 12, dec:   4096, order:  6, tag: 'Bluesky',    root: 'https://bsky.app/profile/',     suffix: '',     icon: 'fa-brands fa-bluesky',   live: false, verifyKey: 'bluesky'   },
    { index: 13, dec:   8192, order:  7, tag: 'Threads',    root: 'https://www.threads.net/@',     suffix: '',     icon: 'fa-brands fa-threads',   live: false, verifyKey: 'threads'   },
    { index: 14, dec:  16384, order:  9, tag: 'GitHub',     root: 'https://github.com/',           suffix: '',     icon: 'fab fa-github',          live: false, verifyKey: 'github'    },
    { index: 15, dec:  32768, order: 10, tag: 'Reddit',     root: 'https://www.reddit.com/user/',  suffix: '',     icon: 'fab fa-reddit-alien',    live: false, verifyKey: 'reddit'    },
    { index: 16, dec:  65536, order: 11, tag: 'Snapchat',   root: 'https://www.snapchat.com/add/', suffix: '',     icon: 'fab fa-snapchat',        live: false, verifyKey: 'snapchat'  },
    { index: 17, dec: 131072, order: 15, tag: 'Substack',   root: 'https://substack.com/@',        suffix: '',     icon: 'fas fa-newspaper',       live: false, verifyKey: 'substack'  },
];
...
function getHTML(handle, showURL, links) {
    ...
    for (let i = 0; i < lnxObjects.length; i++) {
        ...
        if (links) {
            ...
            var platformAttr = obj.verifyKey ? ' data-platform="' + obj.verifyKey + '"' : '';
            thisHTML = '<input class="hidden" id="' + theID + '" type="checkbox" onClick="updateAll()" value="' + obj.dec + '">'
                     + '<label class="" for="' + theID + '"' + platformAttr + '><span class="text">' + innerLabel + '</span></label>';
